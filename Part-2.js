...
let currentId = 0; // Had this. 

// list of all of the movies in memory for sorting purposes. 
let moviesList = [];

$(function () {
    // when you click the delete button, remove the closest parent tr
    // That is most of what I was looking for in my version. 
    ...
    // When the delete button is clicked, remove hte closest parent tr and remove from the array of movies.
...
// accepts an array of objects and a akey and sorts by that key
...
// createMovieDataHTML accepts an object with title and rating keys and retuns a string of HTML
